...
| Believe It! | Verified (Session 4) | Narutopedia "Dattebayo and Believe It": the English dub renders Naruto's verbal tic "dattebayo" as "Believe it!". Used as the title of the top achievement (complete Part I and Part II) |
...
<!-- NAMES:START -->
_Generated by `node tools/naming.mjs --write` from the content files — 486 distinct names._
...
| Naruto Uzumaki (Nine-Tails Chakra Mode) | Pullable (kage) | [Nine-Tails Chakra Mode](https://naruto.fandom.com/wiki/Nine-Tails_Chakra_Mode) | Verified | Achievement-exclusive form (Session 4). The article has no separate English TV field, so the dub keeps "Nine-Tails Chakra Mode" (other names: Kurama Chakra Mode, Tailed Beast Chakra Mode). Debut anime ep 247 (Shippuden). |
...
| Planet Rasengan | Ult: Chakra Mode | [Planetary Rasengan](https://naruto.fandom.com/wiki/Planetary_Rasengan) | Verified | Narutopedia "English TV" (dub) field of the Planetary Rasengan; Naruto is the only user (debut Shippuden ep 300, in Nine-Tails Chakra Mode). |
